                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="card">
                            ...
                            <div class="content">
                                <form method="post" action="CustDelete">
                                    <div class="row">
                                        <div class="col-md-10">
                                    ...
                                    <div>
                                    	<input type="hidden" class="form-control" placeholder="Cust ID" name="c_id" value="${customer.c_id}" hidden>
								  		<button type="submit" class="btn btn-danger btn-fill pull-left" id="delete" name="deleteCust" value="Delete" onclick=" return myFunction()">Delete</button>
								    </div>
