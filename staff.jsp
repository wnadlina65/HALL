                                ...
                                <form method="post" action="StaffUpdate">
                    				...
                    				<div>
                    					<input type="hidden" name="s_no" value="${staff.s_no}" hidden>
								  		<input type="submit" id="update" name="save" value="Update" onclick="return myFunction()" class="btn btn-info btn-fill pull-left">
								  	</div>
...
<script>
	function myFunction() {
	  ...
	  var r = confirm("Are you sure to udpate this data?");
	  if (r == true) {
	    txt = "Update";
	  } 
	  else {
