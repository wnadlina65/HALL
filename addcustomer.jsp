            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-10">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Add New Customer Details</h4>
                            </div>
                            <div class="content">
                                <form name="addForm" method="post" action="InsertCust">
                                    <div class="row">
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                <label>Customer's Name</label>
                                                <input type="text" name="c_name" class="form-control" placeholder="Enter Customer's Name" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="c_phone" class="form-control" minlength="10" maxlength="11" placeholder="Enter Phone No." required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                <label>Zipcode</label>
                                                <input type="text" name="c_zipcode" class="form-control" maxlength="5" placeholder="Enter Zipcode" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                <label>City</label>
                                                <input type="text" name="c_city" class="form-control" placeholder="Enter City" required>
                                            </div>
                                        </div>
                                    </div>

                                    <button type="submit" class="btn btn-info btn-fill pull-left" name="save" value="Submit">Submit</button>
