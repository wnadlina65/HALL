...
<%
	...
	request.setAttribute("staff", StaffDAO.getStaff((String) session.getAttribute("s_no")));
%>
<div class="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">List of Staff</a>
                </div>
                        ...
                        <div class="card">
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        <c:forEach items="${StaffDAO.getStaffBean()}" var="user">
											<tr>
												<td><c:out value="${user.s_id}"></c:out></td>
												<td><c:out value="${user.s_FName}"></c:out></td>
												<td><c:out value="${user.s_LName}"></c:out></td>
												<td><c:out value="${user.s_no}"></c:out></td>
												<td><c:out value="${user.st_id}"></c:out></td>
												<td>
													<a href="staff.jsp?s_no=${user.s_no}">Update</a>
													<a href="staff1.jsp?s_no=${user.s_no}">Delete</a>
												</td>
											</tr>
										</c:forEach>
                                    </tbody>
	...
	<script>
		if (performance.navigation.type == performance.navigation.TYPE_RELOAD) {
	        ...
	        if(id === "1"){
	        	...
	        	setTimeout(function() {
	        		var notify = $.notify('...');
	        		notify.update({'type': 'success', 'message': '<div style="font-size: 20px;"><strong>Successfully Add Data Staff!</strong> </div>'});
	        	}, 300);
	        } 
	        else if(id === "6"){
	        	setTimeout(function() {
