            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-10">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Add Staff Profile</h4>
                            </div>
                            <div class="content">
                                <form method="post" action="InsertStaff">
									...
									<div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="s_no" maxlength="4" placeholder="Staff No" required/>
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                   	...
                                   	<div>
                                   		<button type="submit" name="save" value="Submit" class="btn btn-info btn-fill pull-left">Submit&nbsp; &nbsp;</button>
                                    </div>
