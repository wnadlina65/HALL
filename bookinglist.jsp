...
<%
	BookDAO.setBookBean();
	request.setAttribute("booking", BookDAO.getBook((String) session.getAttribute("bk_id")));
%>
<div class="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">List Booked Hall</a>
                </div>
                        ...
                        <div class="card">
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        <c:forEach items="${BookDAO.getBookBean()}" var="book">
											<tr>
												<td><c:out value="${book.bk_id}"></c:out></td>
												<td><c:out value="${book.bk_name}"></c:out></td>
												<td><c:out value="${book.bk_strdate}"></c:out></td>
												<td><c:out value="${book.bk_enddate}"></c:out></td>
												<td><c:out value="${book.bk_pax}"></c:out></td>
												<td><c:out value="${book.bk_totprice}"></c:out></td>
												<td><c:out value="${book.c_id}"></c:out></td>
												<td><c:out value="${book.h_id}"></c:out></td>
												<td>
													<a href="editbooking.jsp?bk_id=${book.bk_id}">Update</a>
													<a href="editbooking1.jsp?bk_id=${book.bk_id}">Delete</a>
												</td>
											</tr>
										</c:forEach>
                                    </tbody>
	...
	<script>
		if (performance.navigation.type == performance.navigation.TYPE_RELOAD) {
	        ...
	        if(id === "1"){
	        	...
	        	setTimeout(function() {
	        		var notify = $.notify('...');
	        		notify.update({'type': 'success', 'message': '<div style="font-size: 20px;"><strong>Successfully Add New Booking!</strong> </div>'});
	        	}, 300);
	        } 
	        else if(id === "6"){
	        	setTimeout(function() {
	        		var notify = $.notify('...');
	        		notify.update({'type': 'danger', 'message': '<div style="font-size: 20px;"><strong>Add Booking Failed!</strong> </div>'});
	        	}, 300);
	        } 
	        else {
