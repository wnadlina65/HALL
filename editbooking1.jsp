...
<%
	...
	BookDAO.setBookBean();
    request.setAttribute("booking", BookDAO.getBook(bk_id));
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-10">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Edit Booking Details</h4>
                            </div>
                            <div class="content">
                                <form method="post" action="BookDelete">
                                	<div class="row">
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                <label>Event Name (disabled)</label>
                                                <input type="text" class="form-control" name="bk_name" disabled placeholder="Enter Event Name" value="${booking.bk_name}" required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>Start Date/Time</label>
	       										<input type="datetime-local" style="text-transform:uppercase" class="form-control form-control-user" name="bk_strdate" placeholder="Date of booking" value="${booking.bk_strdate}" required></br>
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>End Date/Time</label>
	       										<input type="datetime-local" style="text-transform:uppercase" class="form-control form-control-user" name="bk_enddate" placeholder="Date of booking" value="${booking.bk_enddate}" required></br>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" name="bk_pax" placeholder="Enter No. of Pax" value="${booking.bk_pax}" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="bk_totprice" placeholder="Enter Price (RM)" value="${booking.bk_totprice}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="c_id">
                                                	<option value="NONE">Customer's Name</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="h_id">
                                                  <option value="NONE">Hall Name</option>
                                    ...
                                    <div>
	                                    ...
	                                    <button type="submit" id="delete" name="delete" value="deleteBooking" class="btn btn-danger btn-fill pull-left" onclick="return myFunction()">Delete</button>
								    </div>
