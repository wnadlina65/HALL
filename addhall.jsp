            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-10">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Add Hall Details</h4>
                            </div>
                            <div class="content">
                                <form method="post" action="AddHall">
                                    <div class="row">
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                <label>Hall Name</label>
                                                <input type="text" class="form-control" name="h_name" placeholder="Enter Hall Name" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="h_price" placeholder="Enter Price" required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                ...
                                                <select name="ht_id" required>
											      <option value="NONE">Choose Hall Type</option>
